...
| ------------------------- | ---------------------------------------------------------------- | ------------------------------------------------------------------- |
| Object State              | State can be an object to hold multiple related values in React. | `const [user, setUser] = useState({ name: "Gizem", age: 18 });`     |
...
| ----------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| Object State            | React’te birden fazla ilişkili veriyi tek bir object içinde tutmak için kullanılır. | `const [user, setUser] = useState({ name: "Gizem", age: 18 });`     |
